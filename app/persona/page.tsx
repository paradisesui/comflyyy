  ...
  return (
    <div style={{
      ...
      <main className="dashboard-container">
        ...
        <div className="dashboard-grid">
          ...
          <section style={{
            ...
            <div style={{ position: 'relative', width: '220px', height: '220px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div style={{ position: 'absolute', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <span style={{ fontSize: '11px', color: '#64748b', letterSpacing: '2px', marginTop: '4px', fontWeight: '600' }}>ROOM SCORE</span>
              </div>
            </div>

            <div style={{ textAlign: 'center' }}>
              <span style={{ fontSize: '13px', color: '#94a3b8' }}>ระดับคุณภาพห้องนอน</span>
              <h2 style={{ fontSize: '26px', color: statusColor, fontWeight: '700', margin: '2px 0 0 0' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', justifyContent: 'space-between' }}>
            ...
            <div style={{
              ...
              <div style={{ textAlign: 'center' }}>
                <span style={{ fontSize: '12px', color: '#64748b', display: 'block', marginBottom: '4px' }}>อุณหภูมิ</span>
              ...
              <div style={{ textAlign: 'center', borderLeft: '1px solid #1e293b', borderRight: '1px solid #1e293b' }}>
                <span style={{ fontSize: '12px', color: '#64748b', display: 'block', marginBottom: '4px' }}>ความชื้น</span>
              ...
              <div style={{ textAlign: 'center' }}>
                <span style={{ fontSize: '12px', color: '#64748b', display: 'block', marginBottom: '4px' }}>CO2</span>
        ...
        {/* [NEW] Lower Section: Secondary Sensors Quick Cards */}
        <section style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          <span style={{ fontSize: '12px', color: '#64748b', fontWeight: '600' }}>
            สิ่งแวดล้อมโดยรอบเพิ่มเติม (Environment Status)
          </span>
          <div className="extra-metrics-grid">
            <div style={{ backgroundColor: '#162032', padding: '14px', borderRadius: '16px', border: '1px solid #1e293b' }}>
              <span style={{ fontSize: '11px', color: '#64748b', display: 'block' }}>💡 แสงสว่าง</span>
              <span style={{ fontSize: '16px', fontWeight: '700', color: (sensor?.lux ?? 0) > 5 ? '#f59e0b' : '#34d399' }}>
                {sensor ? `${sensor.lux?.toFixed(1)} Lux` : '--'}
              </span>
            </div>
            <div style={{ backgroundColor: '#162032', padding: '14px', borderRadius: '16px', border: '1px solid #1e293b' }}>
              <span style={{ fontSize: '11px', color: '#64748b', display: 'block' }}>🔊 เสียงรบกวน</span>
              <span style={{ fontSize: '16px', fontWeight: '700', color: (sensor?.sound ?? 0) > 1000 ? '#ef4444' : '#34d399' }}>
                {sensor ? `${sensor.sound}` : '--'}
              </span>
            </div>
            <div style={{ backgroundColor: '#162032', padding: '14px', borderRadius: '16px', border: '1px solid #1e293b' }}>
              <span style={{ fontSize: '11px', color: '#64748b', display: 'block' }}>🌫️ PM2.5</span>
              <span style={{ fontSize: '16px', fontWeight: '700', color: (sensor?.pm2_5 ?? 0) > 15 ? '#f59e0b' : '#34d399' }}>
        ...
        <div style={{
          ...
          <span>Sleep Environment Optimizer v1.0</span>
          <span>Firebase Database Connected</span>
        </div>
      </main>
    </div>
  );
