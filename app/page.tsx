          ...
          <section style={{
            ...
            <div style={{ position: 'relative', width: '180px', height: '180px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div style={{ position: 'absolute', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <span style={{ fontSize: '42px', fontWeight: '800', lineHeight: '1', color: '#fff' }}>{score}%</span>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', justifyContent: 'space-between' }}>
            ...
            <div style={{
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <span style={{ fontSize: '15px', fontWeight: '700', color: (sensor?.temperature ?? 0) > 25 ? '#f59e0b' : '#f1f5f9' }}>
              ...
              <div style={{ textAlign: 'center', borderLeft: '1px solid #1e293b', borderRight: '1px solid #1e293b' }}>
                ...
                <span style={{ fontSize: '15px', fontWeight: '700', color: (sensor?.humidity ?? 0) > 60 || (sensor?.humidity ?? 0) < 40 ? '#f59e0b' : '#f1f5f9' }}>
                  {sensor ? `${sensor.humidity?.toFixed(0)}%` : '--'}
                </span>
              </div>
              <div style={{ textAlign: 'center' }}>
                <span style={{ fontSize: '11px', color: '#64748b', display: 'block' }}>CO2</span>
                <span style={{ fontSize: '15px', fontWeight: '700', color: (sensor?.co2 ?? 0) > 800 ? '#f59e0b' : '#f1f5f9' }}>
