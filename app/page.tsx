      ...
      <main className="bento-container">
        ...
        <header className="header-container" style={{ padding: '0 2px' }}>
          <div className="header-top">
            ...
            <div className="desktop-only-profile" style={{ display: 'none' }}>
        ...
        <div className="hero-grid">
          <div style={{
            ...
            <div style={{ position: 'relative', width: '190px', height: '190px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div style={{ position: 'absolute', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <span style={{ fontSize: '50px', fontWeight: '800', lineHeight: '1', color: '#fff' }}>{score}%</span>
          ...
          <div className="metrics-grid">
            <div style={{ backgroundColor: '#151c2c', padding: '18px', borderRadius: '20px', border: '1px solid #1e293b', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            ...
            <div style={{ backgroundColor: '#151c2c', padding: '18px', borderRadius: '20px', border: '1px solid #1e293b', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              ...
              <span style={{ fontSize: '11px', color: '#34d399' }}>• อยู่ในเกณฑ์</span>
            </div>
            ...
            <div style={{ backgroundColor: '#151c2c', padding: '18px', borderRadius: '20px', border: '1px solid #1e293b', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              ...
              <div style={{ margin: '10px 0' }}>
                ...
                <span style={{ fontSize: '12px', color: '#64748b', marginLeft: '2px' }}>ppm</span>
              </div>
            ...
            <div style={{ backgroundColor: '#151c2c', padding: '18px', borderRadius: '20px', border: '1px solid #1e293b', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              ...
              <div style={{ margin: '10px 0' }}>
                ...
                <span style={{ fontSize: '12px', color: '#64748b', marginLeft: '2px' }}>Lux</span>
              </div>
              <span style={{ fontSize: '11px', color: '#34d399' }}>• มืดสนิท</span>
            </div>
          </div>
        </div>
        ...
        <Link href="/sensitivity" style={{ textDecoration: 'none' }}>
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
              ...
              <div>
                <span style={{ fontSize: '14px', fontWeight: '800', color: '#f8fafc', display: 'block', marginBottom: '2px' }}>
                  วิเคราะห์จุดอ่อนความไวการนอน (AI Sensitivity Profile)
                </span>
                <p style={{ fontSize: '12px', color: '#a5b4fc', margin: 0, lineHeight: '1.4' }}>
                  คำนวณจากประวัติสะดุ้งตื่นจริงคู่เซนเซอร์: พบคุณไวต่อ <strong style={{ color: '#fbbf24' }}>อุณหภูมิ (High Temp Sensitivity)</strong>
                </p>
              </div>
            </div>
            <div style={{
